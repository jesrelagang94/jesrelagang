  ...
  <div :class="active == 1 ? '' : 'news_hidden_details'">
    <ModalBox :close="close">
      <div class="news_popup_informations">
        ...
        <div class="text">
          <p>
            Jesrel Agang is a full-stack developer creating innovative,
            effective web solutions that bring your ideas to life with modern
